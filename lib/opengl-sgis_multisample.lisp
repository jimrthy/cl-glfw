...
(defglextfun "SamplePatternSGIS" sample-pattern-sgis :return "void"
 :args ((:name |pattern| :type |SamplePatternSGIS| :direction :in))
 :category "SGIS_multisample" :deprecated nil :version "1.0") 
...
(make-extension-loader |SGIS_multisample|
 (("SamplePatternSGIS" sample-pattern-sgis :return "void" :args
   ((:name |pattern| :type |SamplePatternSGIS| :direction :in))
   :category "SGIS_multisample" :deprecated nil :version "1.0")
