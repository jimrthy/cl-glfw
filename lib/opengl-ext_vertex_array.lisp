...
(defconstant +texture-coord-array-pointer-ext+ #x8092) 
(defconstant +edge-flag-array-pointer-ext+ #x8093) 
(defglextfun "VertexPointerEXT" vertex-pointer-ext :return "void"
 :args
...
(defglextfun "TexCoordPointerEXT" tex-coord-pointer-ext :return
 "void" :args
 ((:name |size| :type |Int32| :direction :in)
  ...
  (:name |pointer| :type |Void| :direction :in :array t :size
   (|size| |type| |stride| |count|) :retained t))
 :category "EXT_vertex_array" :deprecated nil :version "1.0") 
(defglextfun "NormalPointerEXT" normal-pointer-ext :return "void"
 :args
...
(defglextfun "GetPointervEXT" get-pointerv-ext :return "void" :args
 ((:name |pname| :type |GetPointervPName| :direction :in)
  (:name |params| :type |VoidPointer| :direction :out :array t :size
   #x1))
 :category "EXT_vertex_array" :deprecated nil :version "1.0") 
(defglextfun "EdgeFlagPointerEXT" edge-flag-pointer-ext :return
 "void" :args
 ((:name |stride| :type |SizeI| :direction :in)
  (:name |count| :type |SizeI| :direction :in)
...
(defglextfun "ArrayElementEXT" array-element-ext :return "void" :args
 ((:name \i :type |Int32| :direction :in)) :category
 "EXT_vertex_array" :deprecated nil :version "1.0") 
