...
(defglextfun "BlendFuncSeparateiARB" blend-func-separate-i-arb
 :return "void" :args
...
(defglextfun "BlendFunciARB" blend-func-i-arb :return "void" :args
 ...
 :category "ARB_draw_buffers_blend" :deprecated nil :version "1.2") 
(defglextfun "BlendEquationSeparateiARB"
 blend-equation-separate-i-arb :return "void" :args
 ((:name |buf| :type |UInt32| :direction :in)
  (:name |modeRGB| :type |GLenum| :direction :in)
  (:name |modeAlpha| :type |GLenum| :direction :in))
 :category "ARB_draw_buffers_blend" :deprecated nil :version "1.2") 
(defglextfun "BlendEquationiARB" blend-equation-i-arb :return "void"
 :args
 ((:name |buf| :type |UInt32| :direction :in)
  (:name |mode| :type |GLenum| :direction :in))
 :category "ARB_draw_buffers_blend" :deprecated nil :version "1.2") 
(make-extension-loader |ARB_draw_buffers_blend|
 (("BlendFuncSeparateiARB" blend-func-separate-i-arb :return "void"
   :args
   ((:name |buf| :type |UInt32| :direction :in)
    (:name |srcRGB| :type |GLenum| :direction :in)
    (:name |dstRGB| :type |GLenum| :direction :in)
  ...
  ("BlendFunciARB" blend-func-i-arb :return "void" :args
   ((:name |buf| :type |UInt32| :direction :in)
    ...
    (:name |dst| :type |GLenum| :direction :in))
   :category "ARB_draw_buffers_blend" :deprecated nil :version "1.2")
  ("BlendEquationSeparateiARB" blend-equation-separate-i-arb :return
   "void" :args
   ((:name |buf| :type |UInt32| :direction :in)
    (:name |modeRGB| :type |GLenum| :direction :in)
    (:name |modeAlpha| :type |GLenum| :direction :in))
  ...
  ("BlendEquationiARB" blend-equation-i-arb :return "void" :args
   ((:name |buf| :type |UInt32| :direction :in)
    (:name |mode| :type |GLenum| :direction :in))
   :category "ARB_draw_buffers_blend" :deprecated nil :version
   "1.2"))) 
