...
(defglextfun "TransformFeedbackStreamAttribsNV"
 ...
 ((:name |count| :type |SizeI| :direction :in)
  ...
  (:name |bufstreams| :type |Int32| :direction :in :array t :size
   nbuffers)
  (:name |bufferMode| :type |GLenum| :direction :in))
 :category "NV_transform_feedback" :deprecated nil :version "4.1") 
(defglextfun "GetTransformFeedbackVaryingNV"
 get-transform-feedback-varying-nv :return "void" :args
 ((:name |program| :type |UInt32| :direction :in)
  (:name |index| :type |UInt32| :direction :in)
  (:name |location| :type |Int32| :direction :out :array t :size
   #x1))
 :category "NV_transform_feedback" :deprecated nil :version "1.5") 
(defglextfun "GetActiveVaryingNV" get-active-varying-nv :return
 "void" :args
 ((:name |program| :type |UInt32| :direction :in)
  (:name |index| :type |UInt32| :direction :in)
 ...
 :category "NV_transform_feedback" :deprecated nil :version "1.5") 
(defglextfun "GetVaryingLocationNV" get-varying-location-nv :return
 "Int32" :args
 ((:name |program| :type |UInt32| :direction :in)
...
(defglextfun "ActiveVaryingNV" active-varying-nv :return "void" :args
 ((:name |program| :type |UInt32| :direction :in)
  (:name |name| :type |Char| :direction :in :array t :size (|name|)))
 :category "NV_transform_feedback" :deprecated nil :version "1.5") 
(defglextfun "TransformFeedbackVaryingsNV"
 transform-feedback-varyings-nv :return "void" :args
 ((:name |program| :type |UInt32| :direction :in)
  (:name |count| :type |SizeI| :direction :in)
  (:name |locations| :type |Int32| :direction :in :array t :size
   count)
  (:name |bufferMode| :type |GLenum| :direction :in))
 :category "NV_transform_feedback" :deprecated nil :version "1.5") 
(defglextfun "BindBufferBaseNV" bind-buffer-base-nv :return "void"
 :args
 ((:name |target| :type |GLenum| :direction :in)
  (:name |index| :type |UInt32| :direction :in)
  (:name |buffer| :type |UInt32| :direction :in))
 :category "NV_transform_feedback" :deprecated nil :version "1.5") 
(defglextfun "BindBufferOffsetNV" bind-buffer-offset-nv :return
 "void" :args
 ((:name |target| :type |GLenum| :direction :in)
  (:name |index| :type |UInt32| :direction :in)
  (:name |buffer| :type |UInt32| :direction :in)
 ...
 :category "NV_transform_feedback" :deprecated nil :version "1.5") 
(defglextfun "BindBufferRangeNV" bind-buffer-range-nv :return "void"
 :args
 ((:name |target| :type |GLenum| :direction :in)
  (:name |index| :type |UInt32| :direction :in)
  (:name |buffer| :type |UInt32| :direction :in)
 ...
 :category "NV_transform_feedback" :deprecated nil :version "1.5") 
(defglextfun "TransformFeedbackAttribsNV"
 transform-feedback-attribs-nv :return "void" :args
 ((:name |count| :type |UInt32| :direction :in)
  (:name |attribs| :type |Int32| :direction :in :array t :size
   (|count|))
  (:name |bufferMode| :type |GLenum| :direction :in))
 :category "NV_transform_feedback" :deprecated nil :version "1.5") 
(defglextfun "EndTransformFeedbackNV" end-transform-feedback-nv
 :return "void" :args nil :category "NV_transform_feedback"
 :deprecated nil :version "1.5") 
(defglextfun "BeginTransformFeedbackNV" begin-transform-feedback-nv
 :return "void" :args
...
(make-extension-loader |NV_transform_feedback|
 (("TransformFeedbackStreamAttribsNV"
   ...
   ((:name |count| :type |SizeI| :direction :in)
    ...
    (:name |bufferMode| :type |GLenum| :direction :in))
   :category "NV_transform_feedback" :deprecated nil :version "4.1")
  ("GetTransformFeedbackVaryingNV" get-transform-feedback-varying-nv
   :return "void" :args
   ((:name |program| :type |UInt32| :direction :in)
    (:name |index| :type |UInt32| :direction :in)
    (:name |location| :type |Int32| :direction :out :array t :size
  ...
  ("GetActiveVaryingNV" get-active-varying-nv :return "void" :args
   ((:name |program| :type |UInt32| :direction :in)
    ...
    (:name |name| :type |Char| :direction :out :array t :size
     (|program| |index| |bufSize|)))
   :category "NV_transform_feedback" :deprecated nil :version "1.5")
  ("GetVaryingLocationNV" get-varying-location-nv :return "Int32"
   :args
   ((:name |program| :type |UInt32| :direction :in)
  ...
  ("ActiveVaryingNV" active-varying-nv :return "void" :args
   ((:name |program| :type |UInt32| :direction :in)
    (:name |name| :type |Char| :direction :in :array t :size
     (|name|)))
   :category "NV_transform_feedback" :deprecated nil :version "1.5")
  ("TransformFeedbackVaryingsNV" transform-feedback-varyings-nv
   :return "void" :args
   ((:name |program| :type |UInt32| :direction :in)
    (:name |count| :type |SizeI| :direction :in)
    (:name |locations| :type |Int32| :direction :in :array t :size
  ...
  ("BindBufferRangeNV" bind-buffer-range-nv :return "void" :args
   ((:name |target| :type |GLenum| :direction :in)
    ...
    (:name |size| :type |BufferSize| :direction :in))
   :category "NV_transform_feedback" :deprecated nil :version "1.5")
  ("TransformFeedbackAttribsNV" transform-feedback-attribs-nv :return
   "void" :args
   ((:name |count| :type |UInt32| :direction :in)
    (:name |attribs| :type |Int32| :direction :in :array t :size
     (|count|))
    (:name |bufferMode| :type |GLenum| :direction :in))
   :category "NV_transform_feedback" :deprecated nil :version "1.5")
  ("EndTransformFeedbackNV" end-transform-feedback-nv :return "void"
   :args nil :category "NV_transform_feedback" :deprecated nil
   :version "1.5")
  ("BeginTransformFeedbackNV" begin-transform-feedback-nv :return
   "void" :args
   ((:name |primitiveMode| :type |GLenum| :direction :in)) :category
   "NV_transform_feedback" :deprecated nil :version "1.5"))) 
