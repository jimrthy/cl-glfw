...
(defglextfun "GetVertexAttribArrayObjectivATI"
 ...
 ((:name |index| :type |UInt32| :direction :in)
  ...
  (:name |params| :type |Int32| :direction :out :array t :size
   pname))
 :category "ATI_vertex_attrib_array_object" :deprecated nil :version
 "1.2") 
(defglextfun "GetVertexAttribArrayObjectfvATI"
 ...
 :category "ATI_vertex_attrib_array_object" :deprecated nil :version
 "1.2") 
(defglextfun "VertexAttribArrayObjectATI"
 vertex-attrib-array-object-ati :return "void" :args
 ((:name |index| :type |UInt32| :direction :in)
...
(make-extension-loader |ATI_vertex_attrib_array_object|
 (("GetVertexAttribArrayObjectivATI"
   ...
   ((:name |index| :type |UInt32| :direction :in)
    ...
    (:name |params| :type |Int32| :direction :out :array t :size
     pname))
   :category "ATI_vertex_attrib_array_object" :deprecated nil
   :version "1.2")
  ("GetVertexAttribArrayObjectfvATI"
   ...
   :category "ATI_vertex_attrib_array_object" :deprecated nil
   :version "1.2")
  ("VertexAttribArrayObjectATI" vertex-attrib-array-object-ati
   :return "void" :args
   ((:name |index| :type |UInt32| :direction :in)
    (:name |size| :type |Int32| :direction :in)
    (:name |type| :type |VertexAttribPointerTypeARB| :direction :in)
