...
(defglextfun "FramebufferTextureLayer" framebuffer-texture-layer
 :return "void" :args
...
(defglextfun "RenderbufferStorageMultisample"
 renderbuffer-storage-multisample :return "void" :args
...
(defglextfun "GetFramebufferAttachmentParameteriv"
 ...
 ((:name |target| :type |FramebufferTarget| :direction :in)
  ...
  (:name |params| :type |Int32| :direction :out :array t :size
   (|pname|)))
 :category "ARB_framebuffer_object" :deprecated nil :version "3.0") 
(defglextfun "FramebufferRenderbuffer" framebuffer-renderbuffer
 :return "void" :args
 ((:name |target| :type |FramebufferTarget| :direction :in)
  (:name |attachment| :type |FramebufferAttachment| :direction :in)
 ...
 :category "ARB_framebuffer_object" :deprecated nil :version "3.0") 
(defglextfun "FramebufferTexture3D" framebuffer-texture-3d :return
 "void" :args
 ((:name |target| :type |FramebufferTarget| :direction :in)
  (:name |attachment| :type |FramebufferAttachment| :direction :in)
 ...
 :category "ARB_framebuffer_object" :deprecated nil :version "3.0") 
(defglextfun "FramebufferTexture2D" framebuffer-texture-2d :return
 "void" :args
 ((:name |target| :type |FramebufferTarget| :direction :in)
  (:name |attachment| :type |FramebufferAttachment| :direction :in)
  (:name |textarget| :type |GLenum| :direction :in)
...
(defglextfun "FramebufferTexture1D" framebuffer-texture-1d :return
 ...
 ((:name |target| :type |FramebufferTarget| :direction :in)
  ...
  (:name |level| :type |Int32| :direction :in))
 :category "ARB_framebuffer_object" :deprecated nil :version "3.0") 
(defglextfun "CheckFramebufferStatus" check-framebuffer-status
 :return "GLenum" :args
 ((:name |target| :type |FramebufferTarget| :direction :in))
 :category "ARB_framebuffer_object" :deprecated nil :version "3.0") 
(defglextfun "GenFramebuffers" gen-framebuffers :return "void" :args
 ((:name \n :type |SizeI| :direction :in)
  (:name |framebuffers| :type |UInt32| :direction :out :array t :size
   n))
 :category "ARB_framebuffer_object" :deprecated nil :version "3.0") 
(defglextfun "DeleteFramebuffers" delete-framebuffers :return "void"
 :args
 ((:name \n :type |SizeI| :direction :in)
...
(defglextfun "IsFramebuffer" is-framebuffer :return "Boolean" :args
 ...
 "ARB_framebuffer_object" :deprecated nil :version "3.0") 
(defglextfun "GetRenderbufferParameteriv"
 get-renderbuffer-parameter-iv :return "void" :args
 ((:name |target| :type |RenderbufferTarget| :direction :in)
  (:name |pname| :type |GLenum| :direction :in)
  (:name |params| :type |Int32| :direction :out :array t :size
   (|pname|)))
 :category "ARB_framebuffer_object" :deprecated nil :version "3.0") 
(defglextfun "RenderbufferStorage" renderbuffer-storage :return
 "void" :args
 ((:name |target| :type |RenderbufferTarget| :direction :in)
  (:name |internalformat| :type |GLenum| :direction :in)
  (:name |width| :type |SizeI| :direction :in)
  (:name |height| :type |SizeI| :direction :in))
 :category "ARB_framebuffer_object" :deprecated nil :version "3.0") 
(defglextfun "GenRenderbuffers" gen-renderbuffers :return "void"
 :args
 ((:name \n :type |SizeI| :direction :in)
  (:name |renderbuffers| :type |UInt32| :direction :out :array t
   :size n))
 :category "ARB_framebuffer_object" :deprecated nil :version "3.0") 
(defglextfun "DeleteRenderbuffers" delete-renderbuffers :return
 "void" :args
 ((:name \n :type |SizeI| :direction :in)
  (:name |renderbuffers| :type |UInt32| :direction :in :array t :size
   n))
 :category "ARB_framebuffer_object" :deprecated nil :version "3.0") 
(defglextfun "BindRenderbuffer" bind-renderbuffer :return "void"
 :args
 ((:name |target| :type |RenderbufferTarget| :direction :in)
  (:name |renderbuffer| :type |UInt32| :direction :in))
 :category "ARB_framebuffer_object" :deprecated nil :version "3.0") 
...
(make-extension-loader |ARB_framebuffer_object|
 (("FramebufferTextureLayer" framebuffer-texture-layer :return "void"
   :args
   ((:name |target| :type |FramebufferTarget| :direction :in)
    (:name |attachment| :type |FramebufferAttachment| :direction :in)
    (:name |texture| :type |Texture| :direction :in)
    ...
    (:name |layer| :type |CheckedInt32| :direction :in))
   :category "ARB_framebuffer_object" :deprecated nil :version "3.0")
  ("RenderbufferStorageMultisample" renderbuffer-storage-multisample
   :return "void" :args
   ((:name |target| :type |GLenum| :direction :in)
    (:name |samples| :type |SizeI| :direction :in)
    (:name |internalformat| :type |GLenum| :direction :in)
  ...
  ("GetFramebufferAttachmentParameteriv"
   ...
   ((:name |target| :type |FramebufferTarget| :direction :in)
    ...
    (:name |params| :type |Int32| :direction :out :array t :size
     (|pname|)))
   :category "ARB_framebuffer_object" :deprecated nil :version "3.0")
  ("FramebufferRenderbuffer" framebuffer-renderbuffer :return "void"
   :args
   ((:name |target| :type |FramebufferTarget| :direction :in)
    (:name |attachment| :type |FramebufferAttachment| :direction :in)
    (:name |renderbuffertarget| :type |RenderbufferTarget| :direction
  ...
  ("FramebufferTexture1D" framebuffer-texture-1d :return "void" :args
   ((:name |target| :type |FramebufferTarget| :direction :in)
    ...
    (:name |level| :type |Int32| :direction :in))
   :category "ARB_framebuffer_object" :deprecated nil :version "3.0")
  ("CheckFramebufferStatus" check-framebuffer-status :return "GLenum"
   :args ((:name |target| :type |FramebufferTarget| :direction :in))
   :category "ARB_framebuffer_object" :deprecated nil :version "3.0")
  ...
  ("IsFramebuffer" is-framebuffer :return "Boolean" :args
   ((:name |framebuffer| :type |UInt32| :direction :in)) :category
   "ARB_framebuffer_object" :deprecated nil :version "3.0")
  ("GetRenderbufferParameteriv" get-renderbuffer-parameter-iv :return
   "void" :args
   ((:name |target| :type |RenderbufferTarget| :direction :in)
    (:name |pname| :type |GLenum| :direction :in)
    (:name |params| :type |Int32| :direction :out :array t :size
