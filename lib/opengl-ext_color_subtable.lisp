...
(defglextfun "CopyColorSubTableEXT" copy-color-sub-table-ext :return
 "void" :args
...
(defglextfun "ColorSubTableEXT" color-sub-table-ext :return "void"
 :args
 ((:name |target| :type |ColorTableTarget| :direction :in)
  (:name |start| :type |SizeI| :direction :in)
...
(make-extension-loader |EXT_color_subtable|
 (("CopyColorSubTableEXT" copy-color-sub-table-ext :return "void"
   :args
   ((:name |target| :type |ColorTableTarget| :direction :in)
    (:name |start| :type |SizeI| :direction :in)
    (:name \x :type |WinCoord| :direction :in)
