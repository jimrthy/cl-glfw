...
(defconstant +per-stage-constants-nv+ #x8535) 
(defglextfun "GetCombinerStageParameterfvNV"
 get-combiner-stage-parameter-fv-nv :return "void" :args
...
(defglextfun "CombinerStageParameterfvNV"
 combiner-stage-parameter-fv-nv :return "void" :args
 ((:name |stage| :type |CombinerStageNV| :direction :in)
  (:name |pname| :type |CombinerParameterNV| :direction :in)
...
(make-extension-loader |NV_register_combiners2|
 (("GetCombinerStageParameterfvNV" get-combiner-stage-parameter-fv-nv
   :return "void" :args
   ((:name |stage| :type |CombinerStageNV| :direction :in)
    (:name |pname| :type |CombinerParameterNV| :direction :in)
    (:name |params| :type |Float32| :direction :out :array t :size
     (|pname|)))
   :category "NV_register_combiners2" :deprecated nil :version "1.1")
  ("CombinerStageParameterfvNV" combiner-stage-parameter-fv-nv
   :return "void" :args
   ((:name |stage| :type |CombinerStageNV| :direction :in)
    (:name |pname| :type |CombinerParameterNV| :direction :in)
    (:name |params| :type |CheckedFloat32| :direction :in :array t
     :size (|pname|)))
   :category "NV_register_combiners2" :deprecated nil :version
   "1.1"))) 
