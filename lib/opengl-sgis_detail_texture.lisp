...
(defglextfun "GetDetailTexFuncSGIS" get-detail-tex-func-sgis :return
 "void" :args
...
(defglextfun "DetailTexFuncSGIS" detail-tex-func-sgis :return "void"
 :args
 ((:name |target| :type |TextureTarget| :direction :in)
...
(make-extension-loader |SGIS_detail_texture|
 (("GetDetailTexFuncSGIS" get-detail-tex-func-sgis :return "void"
   :args
   ((:name |target| :type |TextureTarget| :direction :in)
    (:name |points| :type |Float32| :direction :out :array t :size
     (|target|)))
