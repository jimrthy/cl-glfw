...
(defconstant +light-model-color-control+ (:use version_1_2)) 
...
(defconstant +alpha-test-qcom+ #xBC0) 
(defconstant +alpha-test-func-qcom+ #xBC1) 
(defconstant +alpha-test-ref-qcom+ #xBC2) 
(defconstant +draw-buffer-ext+ #xC01) 
(defconstant +read-buffer-ext+ #xC02) 
(defconstant +read-buffer-nv+ #xC02) 
...
(defconstant +texture-border-color-nv+ #x1004) 
...
(defconstant +r5-g6-b5-icc-sgix+ (:use |SGIX_icc_texture|)) 
(defconstant +r5-g6-b5-a8-icc-sgix+ (:use |SGIX_icc_texture|)) 
(defconstant +alpha16-icc-sgix+ (:use |SGIX_icc_texture|)) 
(defconstant +luminance16-icc-sgix+ (:use |SGIX_icc_texture|)) 
(defconstant +luminance16-alpha8-icc-sgix+ (:use |SGIX_icc_texture|)) 
(defconstant +ycrcb-422-sgix+ #x81BB) 
(defconstant +ycrcb-444-sgix+ #x81BC) 
(defconstant +red-ext+ #x1903) 
