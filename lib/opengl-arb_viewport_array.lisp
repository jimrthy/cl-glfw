...
(defglextfun "GetFloati_v" get-floati_v :return "void" :args
 ((:name |target| :type |GLenum| :direction :in)
  ...
  (:name |data| :type |Float32| :direction :out :array t :size
   (|target|)))
 :category "ARB_viewport_array" :deprecated nil :version "4.1") 
(defglextfun "DepthRangeIndexed" depth-range-indexed :return "void"
 :args
 ((:name |index| :type |UInt32| :direction :in)
  (:name \n :type |Float64| :direction :in)
  (:name |f| :type |Float64| :direction :in))
 :category "ARB_viewport_array" :deprecated nil :version "4.1") 
(defglextfun "DepthRangeArrayv" depth-range-arrayv :return "void"
 :args
...
(defglextfun "ScissorArrayv" scissor-arrayv :return "void" :args
 ...
 :category "ARB_viewport_array" :deprecated nil :version "4.1") 
(defglextfun "ViewportIndexedfv" viewport-indexed-fv :return "void"
 :args
 ((:name |index| :type |UInt32| :direction :in)
  (:name \v :type |Float32| :direction :in :array t :size #x4))
 :category "ARB_viewport_array" :deprecated nil :version "4.1") 
(defglextfun "ViewportIndexedf" viewport-indexed-f :return "void"
 :args
 ((:name |index| :type |UInt32| :direction :in)
...
(make-extension-loader |ARB_viewport_array|
 (("GetDoublei_v" get-doublei_v :return "void" :args
  ...
  ("DepthRangeArrayv" depth-range-arrayv :return "void" :args
   ((:name |first| :type |UInt32| :direction :in)
    (:name |count| :type |SizeI| :direction :in)
    (:name \v :type |Float64| :direction :in :array t :size
     (|count|)))
   :category "ARB_viewport_array" :deprecated nil :version "4.1")
  ...
  ("ViewportArrayv" viewport-arrayv :return "void" :args
   ((:name |first| :type |UInt32| :direction :in)
    (:name |count| :type |SizeI| :direction :in)
    (:name \v :type |Float32| :direction :in :array t :size
     (|count|)))
   :category "ARB_viewport_array" :deprecated nil :version "4.1"))) 
