...
(defglextfun "GetAttribLocationARB" get-attrib-location-arb :return
 "Int32" :args
...
(defglextfun "GetActiveAttribARB" get-active-attrib-arb :return
 "void" :args
 ((:name |programObj| :type |handleARB| :direction :in)
 ...
 :category "ARB_vertex_shader" :deprecated nil :version "1.2") 
(defglextfun "BindAttribLocationARB" bind-attrib-location-arb :return
 "void" :args
 ((:name |programObj| :type |handleARB| :direction :in)
  (:name |index| :type |UInt32| :direction :in)
  (:name |name| :type |charARB| :direction :in :array t))
...
(make-extension-loader |ARB_vertex_shader|
 (("GetAttribLocationARB" get-attrib-location-arb :return "Int32"
   :args
   ((:name |programObj| :type |handleARB| :direction :in)
    (:name |name| :type |charARB| :direction :in :array t))
   :category "ARB_vertex_shader" :deprecated nil :version "1.2")
  ("GetActiveAttribARB" get-active-attrib-arb :return "void" :args
   ((:name |programObj| :type |handleARB| :direction :in)
    ...
    (:name |name| :type |charARB| :direction :out :array t))
   :category "ARB_vertex_shader" :deprecated nil :version "1.2")
  ("BindAttribLocationARB" bind-attrib-location-arb :return "void"
   :args
   ((:name |programObj| :type |handleARB| :direction :in)
    (:name |index| :type |UInt32| :direction :in)
    (:name |name| :type |charARB| :direction :in :array t))
