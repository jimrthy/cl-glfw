...
(defconstant +transpose-texture-matrix-arb+ #x84E5) 
(defconstant +transpose-color-matrix-arb+ #x84E6) 
(defglextfun "MultTransposeMatrixdARB" mult-transpose-matrix-d-arb :return "void" :args ((:name \m :type |Float64| :direction :in :array t :size #x10)) :category "ARB_transpose_matrix" :deprecated nil :version "1.2") 
(defglextfun "MultTransposeMatrixfARB" mult-transpose-matrix-f-arb :return "void" :args ((:name \m :type |Float32| :direction :in :array t :size #x10)) :category "ARB_transpose_matrix" :deprecated nil :version "1.2") 
(defglextfun "LoadTransposeMatrixdARB" load-transpose-matrix-d-arb :return "void" :args ((:name \m :type |Float64| :direction :in :array t :size #x10)) :category "ARB_transpose_matrix" :deprecated nil :version "1.2") 
(defglextfun "LoadTransposeMatrixfARB" load-transpose-matrix-f-arb :return "void" :args ((:name \m :type |Float32| :direction :in :array t :size #x10)) :category "ARB_transpose_matrix" :deprecated nil :version "1.2") 
