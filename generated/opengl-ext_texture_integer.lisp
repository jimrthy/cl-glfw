...
(defconstant +luminance-alpha-integer-ext+ #x8D9D) 
(defconstant +rgba-integer-mode-ext+ #x8D9E) 
(defglextfun "ClearColorIuiEXT" clear-color-i-ui-ext :return "void"
 :args
...
(defglextfun "ClearColorIiEXT" clear-color-i-i-ext :return "void"
 :args
 ...
 :category "EXT_texture_integer" :deprecated nil :version "2.0") 
(defglextfun "GetTexParameterIuivEXT" get-tex-parameter-i-uiv-ext
 :return "void" :args
...
(defglextfun "GetTexParameterIivEXT" get-tex-parameter-i-iv-ext
 :return "void" :args
 ((:name |target| :type |TextureTarget| :direction :in)
  (:name |pname| :type |GetTextureParameter| :direction :in)
  (:name |params| :type |Int32| :direction :out :array t :size
   (|pname|)))
 :category "EXT_texture_integer" :deprecated nil :version "1.0") 
(defglextfun "TexParameterIuivEXT" tex-parameter-i-uiv-ext :return
 "void" :args
 ((:name |target| :type |TextureTarget| :direction :in)
  ...
  (:name |params| :type |UInt32| :direction :in :array t :size
   (|pname|)))
 :category "EXT_texture_integer" :deprecated nil :version "2.0") 
(defglextfun "TexParameterIivEXT" tex-parameter-i-iv-ext :return
 "void" :args
 ((:name |target| :type |TextureTarget| :direction :in)
  (:name |pname| :type |TextureParameterName| :direction :in)
 ...
 (("ClearColorIuiEXT" clear-color-i-ui-ext :return "void" :args
  ...
  ("ClearColorIiEXT" clear-color-i-i-ext :return "void" :args
   ((:name |red| :type |Int32| :direction :in)
    ...
    (:name |alpha| :type |Int32| :direction :in))
   :category "EXT_texture_integer" :deprecated nil :version "2.0")
  ("GetTexParameterIuivEXT" get-tex-parameter-i-uiv-ext :return
   "void" :args
   ((:name |target| :type |TextureTarget| :direction :in)
    (:name |pname| :type |GetTextureParameter| :direction :in)
    (:name |params| :type |UInt32| :direction :out :array t :size
     (|pname|)))
   :category "EXT_texture_integer" :deprecated nil :version "1.0")
  ("GetTexParameterIivEXT" get-tex-parameter-i-iv-ext :return "void"
   :args
   ((:name |target| :type |TextureTarget| :direction :in)
    (:name |pname| :type |GetTextureParameter| :direction :in)
    (:name |params| :type |Int32| :direction :out :array t :size
