...
(defglextfun "GetShaderSourceARB" get-shader-source-arb :return
 "void" :args
 ((:name |obj| :type |handleARB| :direction :in)
  ...
  (:name |source| :type |charARB| :direction :out :array t :size
   length))
 :category "ARB_shader_objects" :deprecated nil :version "1.2") 
(defglextfun "GetUniformivARB" get-uniform-iv-arb :return "void"
 :args
 ((:name |programObj| :type |handleARB| :direction :in)
  ...
  (:name |params| :type |Int32| :direction :out :array t :size
   (|location|)))
 :category "ARB_shader_objects" :deprecated nil :version "1.2") 
(defglextfun "GetUniformfvARB" get-uniform-fv-arb :return "void"
 :args
 ((:name |programObj| :type |handleARB| :direction :in)
  (:name |location| :type |Int32| :direction :in)
  (:name |params| :type |Float32| :direction :out :array t :size
   (|location|)))
 :category "ARB_shader_objects" :deprecated nil :version "1.2") 
(defglextfun "GetActiveUniformARB" get-active-uniform-arb :return
 "void" :args
 ((:name |programObj| :type |handleARB| :direction :in)
 ...
 :category "ARB_shader_objects" :deprecated nil :version "1.2") 
(defglextfun "GetUniformLocationARB" get-uniform-location-arb :return
 "Int32" :args
 ((:name |programObj| :type |handleARB| :direction :in)
  (:name |name| :type |charARB| :direction :in :array t))
 :category "ARB_shader_objects" :deprecated nil :version "1.2") 
(defglextfun "GetAttachedObjectsARB" get-attached-objects-arb :return
 "void" :args
 ((:name |containerObj| :type |handleARB| :direction :in)
  ...
  (:name |obj| :type |handleARB| :direction :out :array t :size
   count))
 :category "ARB_shader_objects" :deprecated nil :version "1.2") 
(defglextfun "GetInfoLogARB" get-info-log-arb :return "void" :args
 ((:name |obj| :type |handleARB| :direction :in)
  (:name |maxLength| :type |SizeI| :direction :in)
  (:name |length| :type |SizeI| :direction :out :array t :size #x1)
  (:name |infoLog| :type |charARB| :direction :out :array t :size
   length))
 :category "ARB_shader_objects" :deprecated nil :version "1.2") 
(defglextfun "GetObjectParameterivARB" get-object-parameter-iv-arb
 :return "void" :args
 ((:name |obj| :type |handleARB| :direction :in)
  ...
  (:name |params| :type |Int32| :direction :out :array t :size
   pname))
 :category "ARB_shader_objects" :deprecated nil :version "1.2") 
(defglextfun "GetObjectParameterfvARB" get-object-parameter-fv-arb
 :return "void" :args
 ((:name |obj| :type |handleARB| :direction :in)
  (:name |pname| :type |GLenum| :direction :in)
  (:name |params| :type |Float32| :direction :out :array t :size
   pname))
 :category "ARB_shader_objects" :deprecated nil :version "1.2") 
(defglextfun "UniformMatrix4fvARB" uniform-matrix-4fv-arb :return
 "void" :args
 ((:name |location| :type |Int32| :direction :in)
  ...
  (:name |value| :type |Float32| :direction :in :array t :size
   count))
 :category "ARB_shader_objects" :deprecated nil :version "1.2") 
(defglextfun "UniformMatrix3fvARB" uniform-matrix-3fv-arb :return
 "void" :args
 ((:name |location| :type |Int32| :direction :in)
  (:name |count| :type |SizeI| :direction :in)
  (:name |transpose| :type |Boolean| :direction :in)
  (:name |value| :type |Float32| :direction :in :array t :size
   count))
 :category "ARB_shader_objects" :deprecated nil :version "1.2") 
(defglextfun "UniformMatrix2fvARB" uniform-matrix-2fv-arb :return
 "void" :args
 ((:name |location| :type |Int32| :direction :in)
  (:name |count| :type |SizeI| :direction :in)
  (:name |transpose| :type |Boolean| :direction :in)
...
(defglextfun "Uniform1fARB" uniform-1f-arb :return "void" :args
 ((:name |location| :type |Int32| :direction :in)
  (:name \v0 :type |Float32| :direction :in))
 :category "ARB_shader_objects" :deprecated nil :version "1.2") 
(defglextfun "ValidateProgramARB" validate-program-arb :return "void"
 :args ((:name |programObj| :type |handleARB| :direction :in))
 :category "ARB_shader_objects" :deprecated nil :version "1.2") 
(defglextfun "UseProgramObjectARB" use-program-object-arb :return
 "void" :args ((:name |programObj| :type |handleARB| :direction :in))
 :category "ARB_shader_objects" :deprecated nil :version "1.2") 
...
(defglextfun "AttachObjectARB" attach-object-arb :return "void" :args
 ((:name |containerObj| :type |handleARB| :direction :in)
  (:name |obj| :type |handleARB| :direction :in))
 :category "ARB_shader_objects" :deprecated nil :version "1.2") 
(defglextfun "CreateProgramObjectARB" create-program-object-arb
 :return "handleARB" :args nil :category "ARB_shader_objects"
 :deprecated nil :version "1.2") 
(defglextfun "CompileShaderARB" compile-shader-arb :return "void"
 :args ((:name |shaderObj| :type |handleARB| :direction :in))
 :category "ARB_shader_objects" :deprecated nil :version "1.2") 
(defglextfun "ShaderSourceARB" shader-source-arb :return "void" :args
 ((:name |shaderObj| :type |handleARB| :direction :in)
  (:name |count| :type |SizeI| :direction :in)
  (:name |string| :type |charPointerARB| :direction :in :array t
   :size count)
 ...
 (("GetShaderSourceARB" get-shader-source-arb :return "void" :args
  ...
  ("GetActiveUniformARB" get-active-uniform-arb :return "void" :args
   ((:name |programObj| :type |handleARB| :direction :in)
    ...
    (:name |name| :type |charARB| :direction :out :array t))
   :category "ARB_shader_objects" :deprecated nil :version "1.2")
  ("GetUniformLocationARB" get-uniform-location-arb :return "Int32"
   :args
   ((:name |programObj| :type |handleARB| :direction :in)
    (:name |name| :type |charARB| :direction :in :array t))
   :category "ARB_shader_objects" :deprecated nil :version "1.2")
  ("GetAttachedObjectsARB" get-attached-objects-arb :return "void"
   :args
   ((:name |containerObj| :type |handleARB| :direction :in)
    (:name |maxCount| :type |SizeI| :direction :in)
    (:name |count| :type |SizeI| :direction :out :array t :size #x1)
  ...
  ("GetInfoLogARB" get-info-log-arb :return "void" :args
   ((:name |obj| :type |handleARB| :direction :in)
    ...
    (:name |infoLog| :type |charARB| :direction :out :array t :size
     length))
   :category "ARB_shader_objects" :deprecated nil :version "1.2")
  ("GetObjectParameterivARB" get-object-parameter-iv-arb :return
   "void" :args
   ((:name |obj| :type |handleARB| :direction :in)
    (:name |pname| :type |GLenum| :direction :in)
    (:name |params| :type |Int32| :direction :out :array t :size
     pname))
   :category "ARB_shader_objects" :deprecated nil :version "1.2")
  ("GetObjectParameterfvARB" get-object-parameter-fv-arb :return
   "void" :args
   ((:name |obj| :type |handleARB| :direction :in)
    (:name |pname| :type |GLenum| :direction :in)
    (:name |params| :type |Float32| :direction :out :array t :size
  ...
  ("AttachObjectARB" attach-object-arb :return "void" :args
   ((:name |containerObj| :type |handleARB| :direction :in)
    (:name |obj| :type |handleARB| :direction :in))
   :category "ARB_shader_objects" :deprecated nil :version "1.2")
  ("CreateProgramObjectARB" create-program-object-arb :return
   "handleARB" :args nil :category "ARB_shader_objects" :deprecated
   nil :version "1.2")
  ...
  ("ShaderSourceARB" shader-source-arb :return "void" :args
   ((:name |shaderObj| :type |handleARB| :direction :in)
    ...
    (:name |length| :type |Int32| :direction :in :array t :size #x1))
   :category "ARB_shader_objects" :deprecated nil :version "1.2")
  ("CreateShaderObjectARB" create-shader-object-arb :return
   "handleARB" :args
   ((:name |shaderType| :type |GLenum| :direction :in)) :category
   "ARB_shader_objects" :deprecated nil :version "1.2")
