...
(defconstant +sample-shading-arb+ #x8C36) 
(defconstant +min-sample-shading-value-arb+ #x8C37) 
(defglextfun "MinSampleShadingARB" min-sample-shading-arb :return
 "void" :args ((:name |value| :type |ColorF| :direction :in))
 :category "ARB_sample_shading" :deprecated nil :version "1.2") 
