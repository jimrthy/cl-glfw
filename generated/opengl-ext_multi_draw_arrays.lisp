...
(defglextfun "MultiDrawElementsEXT" multi-draw-elements-ext :return
 "void" :args
...
(defglextfun "MultiDrawArraysEXT" multi-draw-arrays-ext :return
 "void" :args
 ((:name |mode| :type |BeginMode| :direction :in)
...
(make-extension-loader |EXT_multi_draw_arrays|
 (("MultiDrawElementsEXT" multi-draw-elements-ext :return "void"
   :args
   ((:name |mode| :type |BeginMode| :direction :in)
    (:name |count| :type |SizeI| :direction :in :array t :size
     (|primcount|))
    (:name |type| :type |DrawElementsType| :direction :in)
    (:name |indices| :type |VoidPointer| :direction :in :array t
     :size (|primcount|))
    (:name |primcount| :type |SizeI| :direction :in))
   :category "EXT_multi_draw_arrays" :deprecated nil :version "1.1")
