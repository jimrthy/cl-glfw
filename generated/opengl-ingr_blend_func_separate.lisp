...
(defglextfun "BlendFuncSeparateINGR" blend-func-separate-ingr :return
 "void" :args
...
(make-extension-loader |INGR_blend_func_separate|
 (("BlendFuncSeparateINGR" blend-func-separate-ingr :return "void"
   :args
   ((:name |sfactorRGB| :type |BlendFuncSeparateParameterEXT|
     :direction :in)
    (:name |dfactorRGB| :type |BlendFuncSeparateParameterEXT|
    ...
    (:name |dfactorAlpha| :type |BlendFuncSeparateParameterEXT|
     :direction :in))
   :category "INGR_blend_func_separate" :deprecated nil :version
   "1.0"))) 
