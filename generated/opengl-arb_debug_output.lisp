...
(defglextfun "GetDebugMessageLogARB" get-debug-message-log-arb
 :return "UInt32" :args
...
(defglextfun "DebugMessageCallbackARB" debug-message-callback-arb
 :return "void" :args
 ((:name |callback| :type gldebugprocarb :direction :in)
  (:name |userParam| :type |Void| :direction :in :array t :size
   (|callback|)))
 :category "ARB_debug_output" :deprecated nil :version "4.1") 
(defglextfun "DebugMessageInsertARB" debug-message-insert-arb :return
 "void" :args
 ...
 :category "ARB_debug_output" :deprecated nil :version "4.1") 
(defglextfun "DebugMessageControlARB" debug-message-control-arb
 :return "void" :args
 ((:name |source| :type |GLenum| :direction :in)
  (:name |type| :type |GLenum| :direction :in)
  (:name |severity| :type |GLenum| :direction :in)
...
(make-extension-loader |ARB_debug_output|
 (("GetDebugMessageLogARB" get-debug-message-log-arb :return "UInt32"
   :args
   ((:name |count| :type |UInt32| :direction :in)
    (:name |bufsize| :type |SizeI| :direction :in)
    (:name |sources| :type |GLenum| :direction :out :array t :size
    ...
    (:name |messageLog| :type |Char| :direction :out :array t :size
     (|lengths|)))
   :category "ARB_debug_output" :deprecated nil :version "4.1")
  ("DebugMessageCallbackARB" debug-message-callback-arb :return
   "void" :args
   ((:name |callback| :type gldebugprocarb :direction :in)
    (:name |userParam| :type |Void| :direction :in :array t :size
     (|callback|)))
   :category "ARB_debug_output" :deprecated nil :version "4.1")
  ("DebugMessageInsertARB" debug-message-insert-arb :return "void"
   :args
   ((:name |source| :type |GLenum| :direction :in)
    (:name |type| :type |GLenum| :direction :in)
    (:name |id| :type |UInt32| :direction :in)
    ...
    (:name |buf| :type |Char| :direction :in :array t :size length))
   :category "ARB_debug_output" :deprecated nil :version "4.1")
  ("DebugMessageControlARB" debug-message-control-arb :return "void"
   :args
   ((:name |source| :type |GLenum| :direction :in)
    (:name |type| :type |GLenum| :direction :in)
    (:name |severity| :type |GLenum| :direction :in)
