...
(defglextfun "GetPerfMonitorCounterDataAMD"
 get-perf-monitor-counter-data-amd :return "void" :args
 ((:name |monitor| :type |UInt32| :direction :in)
  (:name |pname| :type |GLenum| :direction :in)
  (:name |dataSize| :type |SizeI| :direction :in)
  (:name |data| :type |UInt32| :direction :out :array t :size
   datasize)
  (:name |bytesWritten| :type |Int32| :direction :out :array t :size
   #x1))
 :category "AMD_performance_monitor" :deprecated nil :version "1.2") 
(defglextfun "EndPerfMonitorAMD" end-perf-monitor-amd :return "void"
 :args ((:name |monitor| :type |UInt32| :direction :in)) :category
 "AMD_performance_monitor" :deprecated nil :version "1.2") 
(defglextfun "BeginPerfMonitorAMD" begin-perf-monitor-amd :return
 "void" :args ((:name |monitor| :type |UInt32| :direction :in))
 :category "AMD_performance_monitor" :deprecated nil :version "1.2") 
(defglextfun "SelectPerfMonitorCountersAMD"
 select-perf-monitor-counters-amd :return "void" :args
 ((:name |monitor| :type |UInt32| :direction :in)
  ...
  (:name |counterList| :type |UInt32| :direction :out :array t :size
   numcounters))
 :category "AMD_performance_monitor" :deprecated nil :version "1.2") 
(defglextfun "DeletePerfMonitorsAMD" delete-perf-monitors-amd :return
 "void" :args
 ((:name \n :type |SizeI| :direction :in)
  (:name |monitors| :type |UInt32| :direction :out :array t :size n))
 :category "AMD_performance_monitor" :deprecated nil :version "1.2") 
(defglextfun "GenPerfMonitorsAMD" gen-perf-monitors-amd :return
 "void" :args
 ((:name \n :type |SizeI| :direction :in)
  (:name |monitors| :type |UInt32| :direction :out :array t :size n))
 :category "AMD_performance_monitor" :deprecated nil :version "1.2") 
(defglextfun "GetPerfMonitorCounterInfoAMD"
 get-perf-monitor-counter-info-amd :return "void" :args
 ((:name |group| :type |UInt32| :direction :in)
...
(defglextfun "GetPerfMonitorCounterStringAMD"
 ...
 ((:name |group| :type |UInt32| :direction :in)
  ...
  (:name |counterString| :type |Char| :direction :out :array t :size
   bufsize))
 :category "AMD_performance_monitor" :deprecated nil :version "1.2") 
(defglextfun "GetPerfMonitorGroupStringAMD"
 get-perf-monitor-group-string-amd :return "void" :args
 ((:name |group| :type |UInt32| :direction :in)
  (:name |bufSize| :type |SizeI| :direction :in)
  (:name |length| :type |SizeI| :direction :out :array t :size #x1)
  (:name |groupString| :type |Char| :direction :out :array t :size
   bufsize))
 :category "AMD_performance_monitor" :deprecated nil :version "1.2") 
(defglextfun "GetPerfMonitorCountersAMD"
 get-perf-monitor-counters-amd :return "void" :args
 ((:name |group| :type |UInt32| :direction :in)
  (:name |numCounters| :type |Int32| :direction :out :array t :size
   #x1)
  (:name |maxActiveCounters| :type |Int32| :direction :out :array t
   :size #x1)
  (:name |counterSize| :type |SizeI| :direction :in)
  (:name |counters| :type |UInt32| :direction :out :array t :size
   countersize))
 :category "AMD_performance_monitor" :deprecated nil :version "1.2") 
(defglextfun "GetPerfMonitorGroupsAMD" get-perf-monitor-groups-amd
 :return "void" :args
 ((:name |numGroups| :type |Int32| :direction :out :array t :size
   #x1)
  (:name |groupsSize| :type |SizeI| :direction :in)
  (:name |groups| :type |UInt32| :direction :out :array t :size
   groupssize))
 :category "AMD_performance_monitor" :deprecated nil :version "1.2") 
(make-extension-loader |AMD_performance_monitor|
 (("GetPerfMonitorCounterDataAMD" get-perf-monitor-counter-data-amd
   :return "void" :args
   ((:name |monitor| :type |UInt32| :direction :in)
    (:name |pname| :type |GLenum| :direction :in)
    (:name |dataSize| :type |SizeI| :direction :in)
    (:name |data| :type |UInt32| :direction :out :array t :size
     datasize)
    (:name |bytesWritten| :type |Int32| :direction :out :array t
     :size #x1))
   :category "AMD_performance_monitor" :deprecated nil :version
   "1.2")
  ...
  ("BeginPerfMonitorAMD" begin-perf-monitor-amd :return "void" :args
   ((:name |monitor| :type |UInt32| :direction :in)) :category
   "AMD_performance_monitor" :deprecated nil :version "1.2")
  ("SelectPerfMonitorCountersAMD" select-perf-monitor-counters-amd
   :return "void" :args
   ((:name |monitor| :type |UInt32| :direction :in)
    (:name |enable| :type |Boolean| :direction :in)
    (:name |group| :type |UInt32| :direction :in)
    (:name |numCounters| :type |Int32| :direction :in)
    (:name |counterList| :type |UInt32| :direction :out :array t
     :size numcounters))
   :category "AMD_performance_monitor" :deprecated nil :version
   "1.2")
  ("DeletePerfMonitorsAMD" delete-perf-monitors-amd :return "void"
   :args
   ((:name \n :type |SizeI| :direction :in)
    (:name |monitors| :type |UInt32| :direction :out :array t :size
     n))
   :category "AMD_performance_monitor" :deprecated nil :version
   "1.2")
  ("GenPerfMonitorsAMD" gen-perf-monitors-amd :return "void" :args
   ...
   :category "AMD_performance_monitor" :deprecated nil :version
   "1.2")
  ("GetPerfMonitorCounterInfoAMD" get-perf-monitor-counter-info-amd
   :return "void" :args
   ((:name |group| :type |UInt32| :direction :in)
    (:name |counter| :type |UInt32| :direction :in)
    (:name |pname| :type |GLenum| :direction :in)
  ...
  ("GetPerfMonitorCounterStringAMD"
   ...
   ((:name |group| :type |UInt32| :direction :in)
    ...
    (:name |bufSize| :type |SizeI| :direction :in)
    (:name |length| :type |SizeI| :direction :out :array t :size #x1)
    (:name |counterString| :type |Char| :direction :out :array t
     :size bufsize))
   :category "AMD_performance_monitor" :deprecated nil :version
   "1.2")
  ("GetPerfMonitorGroupStringAMD" get-perf-monitor-group-string-amd
   :return "void" :args
   ((:name |group| :type |UInt32| :direction :in)
    (:name |bufSize| :type |SizeI| :direction :in)
    (:name |length| :type |SizeI| :direction :out :array t :size #x1)
   ...
   :category "AMD_performance_monitor" :deprecated nil :version
   "1.2")
  ("GetPerfMonitorCountersAMD" get-perf-monitor-counters-amd :return
   "void" :args
   ((:name |group| :type |UInt32| :direction :in)
    (:name |numCounters| :type |Int32| :direction :out :array t :size
     #x1)
   ...
   :category "AMD_performance_monitor" :deprecated nil :version
   "1.2")
  ("GetPerfMonitorGroupsAMD" get-perf-monitor-groups-amd :return
   "void" :args
   ((:name |numGroups| :type |Int32| :direction :out :array t :size
     #x1)
    (:name |groupsSize| :type |SizeI| :direction :in)
