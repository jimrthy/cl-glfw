...
(defglextfun "GetQueryObjectuivARB" get-query-object-uiv-arb :return
 "void" :args
...
(defglextfun "GetQueryObjectivARB" get-query-object-iv-arb :return
 "void" :args
 ((:name |id| :type |UInt32| :direction :in)
  (:name |pname| :type |GLenum| :direction :in)
...
(defglextfun "IsQueryARB" is-query-arb :return "Boolean" :args
 ...
 "ARB_occlusion_query" :deprecated nil :version "1.5") 
(defglextfun "DeleteQueriesARB" delete-queries-arb :return "void"
 :args
...
(make-extension-loader |ARB_occlusion_query|
 (("GetQueryObjectuivARB" get-query-object-uiv-arb :return "void"
   :args
   ((:name |id| :type |UInt32| :direction :in)
    (:name |pname| :type |GLenum| :direction :in)
    (:name |params| :type |UInt32| :direction :out :array t :size
