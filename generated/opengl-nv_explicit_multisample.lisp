...
(defconstant +unsigned-int-sampler-renderbuffer-nv+ #x8E58) 
(defconstant +max-sample-mask-words-nv+ #x8E59) 
(defglextfun "TexRenderbufferNV" tex-renderbuffer-nv :return "void"
 :args
...
(defglextfun "SampleMaskIndexedNV" sample-mask-indexed-nv :return
 "void" :args
 ((:name |index| :type |UInt32| :direction :in)
  (:name |mask| :type |SampleMaskNV| :direction :in))
 :category "NV_explicit_multisample" :deprecated nil :version nil) 
(defglextfun "GetMultisamplefvNV" get-multisample-fv-nv :return
 "void" :args
