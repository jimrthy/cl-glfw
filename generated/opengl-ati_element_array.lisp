...
(defconstant +element-array-type-ati+ #x8769) 
(defconstant +element-array-pointer-ati+ #x876A) 
(defglextfun "DrawRangeElementArrayATI" draw-range-element-array-ati
 :return "void" :args
...
(defglextfun "DrawElementArrayATI" draw-element-array-ati :return
 "void" :args
 ((:name |mode| :type |BeginMode| :direction :in)
  (:name |count| :type |SizeI| :direction :in))
 :category "ATI_element_array" :deprecated nil :version "1.2") 
(defglextfun "ElementPointerATI" element-pointer-ati :return "void"
 :args
...
(make-extension-loader |ATI_element_array|
 (("DrawRangeElementArrayATI" draw-range-element-array-ati :return
   "void" :args
   ((:name |mode| :type |BeginMode| :direction :in)
    (:name |start| :type |UInt32| :direction :in)
    (:name |end| :type |UInt32| :direction :in)
